...
<head>
	...
	<script type="text/javascript">
                ...
                $.post("${ctx}/cont/split/detail/item/save",
                    ...
                    function(result){
                        if(result=="success"){
                            ...
                            $.jBox.tip("业务类型添加成功");
                            setTimeout(function () {
                                window.location="${ctx}/cont/split/detail/proc/dist?taskId=${taskId}";
                            }, 500);
                        }else{
        ...
        function commit(){
            ...
            $.post("${ctx}/cont/split/detail/check/process",{id:'${detailId}'},function(data){
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">合同拆解细化-部门分配</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contSplitDetail" action="${ctx}/cont/applyPay/save" method="post" class="form-horizontal" enctype="multipart/form-data">
		...
		<input type="hidden" id="readonly" name="readonly" value="false" />
		...
		<c:forEach items="${contSplitDetailItems}" var="contSplitDetailItem" varStatus="idx">
			...
			<div class="span10">
				...
				<table title="合同拆分细化部门" class="table table-striped table-bordered table-condensed">
					<thead>
					<tr>
						<th>部门</th>
						<th>金额</th>
	...
	<form:form id="procForm" modelAttribute="baseReview" action="${ctx}/cont/split/detail/proc/dist/submit" method="post" class="form-horizontal">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="row-fluid">
						...
						<div class="span2">
							<input class="btn btn-primary" type="button"  onclick="commit();" value="提交" />
						</div>
