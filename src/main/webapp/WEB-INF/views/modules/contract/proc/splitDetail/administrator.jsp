...
<ul class="nav nav-tabs">
	<li class="active"><a href="#">合同拆分细化-合同管理员</a></li>
...
<form:form id="inputForm" modelAttribute="baseReview" action="${ctx}/cont/split/detail/proc/administrator/submit" method="post" class="form-horizontal">
