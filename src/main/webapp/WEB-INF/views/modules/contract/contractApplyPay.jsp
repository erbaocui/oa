...
<head>
	...
	<script type="text/javascript">
        ...
        function downloadFile(id) {
			 window.location.href="${ctx}/cont/base/applyPayDownload?id="+id;

        }
        function preview(id) {
            window.open("${ctx}/cont/base/applyPayPreview?id="+id);
...
<body>
	<ul class="nav nav-tabs">
		...
		<c:if test="${not empty contract.id}">
			<li class="active"><a href="${ctx}/cont/base/applyPay?id=${contract.id}">请款附件</a></li>
	...
	<form id="uploadFileForm"  action="${ctx}/cont/base/applyPayUpload" method="post" enctype="multipart/form-data" class="form-horizontal">
